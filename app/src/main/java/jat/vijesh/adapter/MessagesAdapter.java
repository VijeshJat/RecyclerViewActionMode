...
import jat.vijesh.utility.FlipAnimator;
...
public class MessagesAdapter extends RecyclerView.Adapter<MessagesAdapter.MyViewHolder> {
    ...
    private void applyProfilePicture(final MyViewHolder holder, Message message) {
        if (!TextUtils.isEmpty(message.getPicture())) {
            ...
            Glide.with(mContext)
                    ...
                    .into(new BitmapImageViewTarget(holder.imgProfile) {
                        @Override
